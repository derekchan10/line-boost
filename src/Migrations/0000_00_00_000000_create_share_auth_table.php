...
class CreateShareAuthTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        if (!Schema::hasTable(config('boost.table.sponsor_auth'))) {
            Schema::create(config('boost.table.sponsor_auth'), function (Blueprint $table) {
                $table->engine = 'InnoDB';
                $table->charset = 'utf8';
